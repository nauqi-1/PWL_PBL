            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $periode->periode }}" type="text" name="periode" id="periode" class="form-control" required>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                dataPeriode.ajax.reload(); // memanggil dataPeriode utk instant reload
                            } else {
                                $('.error-text').text('');
