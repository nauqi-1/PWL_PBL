...
@else
<form action="{{ url('/requesttugas/' . $requests->id_request . '/denied_ajax') }}" method="PUT" id="form-deny-request">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Konfirmasi Penolakan Request Tugas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="alert alert-danger">
                    ...
                    Apakah Anda yakin ingin menolak request tugas ini?
                </div>
...
<script>
    $(document).ready(function() {
        $("#form-deny-request").on("submit", function(event) {
