...
@else
<form action="{{ url('/pengumpulan_tugas/' . $tugass->tugas_mahasiswa_id . '/accept_ajax') }}" method="PUT" id="form-accept-tugas">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Konfirmasi Terima Tugas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready(function() {
        $("#form-accept-tugas").on("submit", function(event) {
