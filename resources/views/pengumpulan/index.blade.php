...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link" id="data-riwayat-pengumpulan-tab" data-toggle="pill" href="#data-riwayat-pengumpulan" role="tab" aria-controls="data-riwayat-pengumpulan" aria-selected="false">Riwayat Pengumpulan</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="data-riwayat-pengumpulan" role="tabpanel" aria-labelledby="data-riwayat-pengumpulan-tab">
                ...
                <div class="alert alert-danger">{{ session('error') }}</div>
                @endif
                <table class="table table-bordered table-striped table-hover table-sm" id="table_riwayatpengumpulan">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nama</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        dataPengumpulan = $('#table_pengumpulan').DataTable({
            serverSide: true,
            ajax: {
                url: "{{ url('pengumpulan_tugas/list') }}",
                dataType: "json",
                type: "POST",
                data: function(d) {
            ...
            },
            {
                ...
                render: function(data) {
                    ...
                    if (!data) {
                        return ''; // Jika kosong atau null, tampilkan kosong
                    }
                    // Jika ada tanggal, format dengan moment.js
                    return moment(data).format('DD MMMM YYYY HH:mm');
                }
            },
            {
        ...
        $('#level_id').on('change', function() {
            ...
            dataPengumpulan.ajax.reload(); // Memanggil reload pada DataTable
        });
