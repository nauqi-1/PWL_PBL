...
@else
    <form action="{{ url('/user/' . $user->user_id . '/update_ajax_admin') }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
        ...
        $(document).ready(function() {
            $("#form-edit").validate({
                rules: {
                    ...
                    admin_nama: { required: true, minlength: 3, maxlength: 100 },
                    admin_prodi: { required: true, minlength: 3, maxlength: 50},
